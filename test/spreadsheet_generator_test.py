...
def run_core_token_tests(device_data):
    ...
    test = (
        "We enter 3 consecutive Add Time tokens with the maximum amount of days "
    ...
    test = (
        "We enter 21 consecutive Set Time tokens for 1, 2, 3, … 21 days each "
        "with a count 30 higher than the other. The validation of the token "
    ...
    test = (
        "We deactivate the device with a Set Time of 0 days. We then wait 48 "
        "hours before entering a Add Time of 1 day and ensuring that the days "
